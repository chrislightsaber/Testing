...
public class PokeBreed {
  ...
  public void register(CommandDispatcher<CommandSource> dispatcher) {
    // Set up command.
    dispatcher.register(
            Component test = Component.literal(String.valueOf("pokebreed"));

            test.requires(src -> VeryScuffedCobblemonBreedingPermissions.checkPermission(src,
                            VeryScuffedCobblemonBreeding.permissions.POKEBREED_PERMISSION))
                    .executes(this::execute)
    );
    dispatcher.register(
            Component.literal(String.valueOf("pokebreed"))
  ...
  public class BreedSession {
     ...
     */
    public BreedSession(Player breeder) {
